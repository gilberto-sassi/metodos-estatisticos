...
\begin{figure}[htbp]
	\centering
	\subfloat[][Variáveis aleatórias.]{\includegraphics[width=0.4\linewidth]{figure/pop-2.pdf}\label{fig:pop-2}} \hfill
	\subfloat[][Primeira impressão.]{\includegraphics[width=0.4\linewidth]{figure/boxplot-pop-2.pdf}\label{fig:boxplot-pop-2}}
...
\begin{figure}[htbp]
	\centering
	\subfloat[][Variáveis aleatórias.]{\includegraphics[width=0.4\linewidth]{figure/pop-3.pdf}\label{fig:pop-3}} \hfill
	\subfloat[][Primeira impressão.]{\includegraphics[width=0.4\linewidth]{figure/boxplot-pop-3.pdf}\label{fig:boxplot-pop-3}}
	\caption{Comparação de médias}
\end{figure}
...
\begin{block}{Análise de resíduo}
	\begin{figure}[htbp]
		\centering
		\subfloat[Gráfico de probabilidade normal.]{\includegraphics[width=0.33\linewidth]{figure/qqnorm-balanced-ex1.pdf} \label{fig:qqnorm-balanced-ex1}}
		\subfloat[Tempo $\times$ Resíduos.]{\includegraphics[width=0.33\linewidth]{figure/independence-balanced-ex1.pdf} \label{fig:independence-balanced-ex1}}
		\subfloat[$\bar{y}_{i\cdot}$ $\times$ Resíduos.]{\includegraphics[width=0.33\linewidth]{figure/variance-balanced-ex1.pdf} \label{fig:variance-balanced-ex1}}
...
\begin{frame}{ANOVA}
	...
	\begin{block}{Análise de resíduo}
		\begin{figure}[htbp]
			\centering
			\subfloat[Gráfico de probabilidade normal.]{\includegraphics[width=0.33\linewidth]{figure/qqnorm-unbalanced.pdf} \label{fig:qqnorm-unbalanced}}
			\subfloat[Tempo $\times$ Resíduos.]{\includegraphics[width=0.33\linewidth]{figure/independence-unbalanced.pdf} \label{fig:independence-unbalanced}}
			\subfloat[$\bar{y}_{i\cdot}$ $\times$ Resíduos.]{\includegraphics[width=0.33\linewidth]{figure/variance-unbalanced.pdf} \label{fig:variance-unbalanced}}
			\caption{Análise de resíduos.}
		\end{figure}
	\end{block}
